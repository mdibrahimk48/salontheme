        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="index.html"><img src="<?php echo get_theme_file_uri('images/logo.png');?>" alt="Hair Salon Website Templates Free Download"></a>
                </div>
                    ...
                    <div class="navigation">
                        <div id="navigation">
                            <ul>
                                ...
                                <li class="#"><a href="service-list.html" title="Service List">Service List</a>
                                    <ul>
                                ...
                                <li class="#"><a href="blog-default.html" title="Blog ">News</a>
                                    <ul>
